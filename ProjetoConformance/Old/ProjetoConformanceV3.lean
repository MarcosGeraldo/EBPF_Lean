...
| `(imp_OpCodeK| jne) => return mkAppN (Expr.const ``OpCode.mk []) #[Expr.const ``Msb.bpf_jne [], Expr.const ``Source.bpf_k [], Expr.const ``Lsb.bpf_alu []]
| `(imp_OpCodeK| jneq) => return mkAppN (Expr.const ``OpCode.mk []) #[Expr.const ``Msb.bpf_jneq [], Expr.const ``Source.bpf_k [], Expr.const ``Lsb.bpf_alu []]
| `(imp_OpCodeK| ldh) => return mkAppN (Expr.const ``OpCode.mk []) #[Expr.const ``Msb.bpf_ldh [], Expr.const ``Source.bpf_k [], Expr.const ``Lsb.bpf_alu []]
| `(imp_OpCodeK| ldb) => return mkAppN (Expr.const ``OpCode.mk []) #[Expr.const ``Msb.bpf_ldb [], Expr.const ``Source.bpf_k [], Expr.const ``Lsb.bpf_alu []]
